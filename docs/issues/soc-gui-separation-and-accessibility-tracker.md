...
4. **Phase 7 COMPLETE** — CP8 is closed. Phase 8 is next: move `interactive` into flat `gui.interactive`, including command implementations, while preserving the cheap full-DRC + completion smoke gate.
