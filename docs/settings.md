...
- **`min_escape_length_um`**: The minimum physical escape trace length in micrometers. Default is `3500.0` (3.5 mm). Landing vias and escape stubs are not placed closer than this distance from the pin center.
