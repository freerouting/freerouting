...
Freerouting is a versatile PCB autorouter that works with any PCB design software supporting the standard Specctra or Electra DSN interface. It imports `.dsn` files generated by your CAD software and exports routed `.ses` session files.
...
I ❤️ all contributors — this project wouldn't be possible without you!

- **Report Issues**: Found a bug or have an idea? Open an [issue](https://github.com/freerouting/freerouting/issues).
- **Contribute Code**: Submit fixes and enhancements via [pull requests](https://github.com/freerouting/freerouting/pulls).
- **Guidelines**: Check out the [Contribution Guide](docs/CONTRIBUTING.md) and [Developer Documentation](docs/developer.md). Router and optimizer board scores are documented in [docs/scoring.md](docs/scoring.md).
