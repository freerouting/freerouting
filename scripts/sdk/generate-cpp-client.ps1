param(
    ...
    [string]$OutputDir = "build/sdk/cpp-client",
    [string]$PackageName = "freerouting_cpp_client",
...
$dockerArgs = @(
    ...
    "--skip-validate-spec",
    "--additional-properties", "packageName=$PackageName,packageVersion=$PackageVersion"
)
