 ...
 * <h2>Rationale</h2>
 *
 * <p>The application uses {@link FRLogger#error} for conditions that should never occur under
 ...
 * <h2>Scope</h2>
 *
 * <p>The check covers the full JUnit lifecycle of each test method:
 *
 * <ol>
 ...
 * <h2>Opt-out</h2>
 *
 * <p>Tests that intentionally exercise error-producing code paths should be annotated with {@link
 ...
 *
 * <p>This extension is globally registered via the JUnit 5 service-loader mechanism ({@code
