...
/**
 * JAX-RS {@link jakarta.ws.rs.ext.ExceptionMapper} that converts a {@link
 * jakarta.ws.rs.NotFoundException} into an HTTP 404 Not Found response with a JSON body carrying a
 * human-readable {@code "error"} field and a {@code "documentation"} link.
 *
 ...
 * this mapper ensures all 404 responses from the Freerouting API are consistently JSON-formatted.
 */
@Provider
