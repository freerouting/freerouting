...
/**
 * OpenAPI 3.0 configuration for the Freerouting API. This class provides comprehensive API
 * documentation metadata and security configuration.
 */
@ApplicationPath("/api")
@OpenAPIDefinition(
    info =
        @Info(
            title = "Freerouting API",
            version = "1.0",
            description =
                """
    ...
    tags = {
      @Tag(
          ...
          description = "Endpoints for retrieving the OpenAPI specification in various formats"),
      ...
      @Tag(
          name = "Dev - System",
          description = "Mock system endpoints for testing and development"),
      @Tag(
          name = "Dev - Sessions",
          description = "Mock session endpoints for testing and development"),
