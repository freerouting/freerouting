...
public class JobControllerMocked {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Mock job enqueued successfully", content = @Content(mediaType = MediaType.APPLICATION_JSON))
    })
    @POST
    @Path("/enqueue")
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Mock job list retrieved successfully", content = @Content(mediaType = MediaType.APPLICATION_JSON))
    })
    @GET
    @Path("/list/{sessionId}")
    @Produces(MediaType.APPLICATION_JSON)
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Mock job details retrieved successfully", content = @Content(mediaType = MediaType.APPLICATION_JSON))
    })
    @GET
    @Path("/{jobId}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response getJob(
            @Parameter(description = "Job ID (ignored in mock)", example = "934291f2-8498-4294-a4f4-2058dcfd4edd") @PathParam("jobId") String jobId) {
        return Response.ok("""
                {
                     "id": "934291f2-8498-4294-a4f4-2058dcfd4edd",
                     "createdAt": "2024-10-14T11:18:24.094005900Z",
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Mock job started successfully", content = @Content(mediaType = MediaType.APPLICATION_JSON))
    })
    @PUT
    @Path("/{jobId}/start")
    @Produces(MediaType.APPLICATION_JSON)
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Mock job cancelled successfully", content = @Content(mediaType = MediaType.APPLICATION_JSON))
    })
    @PUT
    @Path("/{jobId}/cancel")
    @Produces(MediaType.APPLICATION_JSON)
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Mock job settings updated successfully", content = @Content(mediaType = MediaType.APPLICATION_JSON))
    })
    @POST
    @Path("/{jobId}/settings")
    @Produces(MediaType.APPLICATION_JSON)
    ...
    public Response changeSettings(
            @Parameter(description = "Job ID (ignored in mock)", example = "934291f2-8498-4294-a4f4-2058dcfd4edd") @PathParam("jobId") String jobId,
            @RequestBody(description = "Router settings (ignored in mock)") RouterSettings routerSettings) {
        return Response.ok("""
                {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Mock input uploaded successfully", content = @Content(mediaType = MediaType.APPLICATION_JSON))
    })
    @POST
    @Path("/{jobId}/input")
    @Produces(MediaType.APPLICATION_JSON)
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Mock output retrieved successfully", content = @Content(mediaType = MediaType.APPLICATION_JSON))
    })
    @GET
    @Path("/{jobId}/output")
    @Produces(MediaType.APPLICATION_JSON)
