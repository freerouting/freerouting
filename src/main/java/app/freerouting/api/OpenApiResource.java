...
/**
 * Resource endpoint for serving the OpenAPI specification. This endpoint generates and serves the
 * OpenAPI spec in JSON and YAML formats.
 */
@Path("/openapi")
@Tag(
    ...
    try {
      ...
      SwaggerConfiguration config =
          new SwaggerConfiguration()
              ...
              .resourceClasses(
                  Set.of(AgentCardController.class.getName(), McpControllerV1.class.getName()))
              .prettyPrint(true);
