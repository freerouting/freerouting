...
/**
 * Custom JAX-RS provider that routes all application/json serialization and deserialization through
 * Gson instead of Yasson/JSON-B.
 *
 * <p>This prevents reflection-based serialization issues in modern Java environments, particularly
 * when returning already-serialized JSON String objects or complex GSON model classes.
 */
@Provider
