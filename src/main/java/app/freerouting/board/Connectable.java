...
public interface Connectable {
  ...
  /**
   * Returns the list of all contacts of a connectable item located at defined connection points. Connection points of traces are there endpoints, connection points of drill_items there center points,
   * and connection points of conduction areas are points on there border.
   */
  Set<Item> get_normal_contacts();

  /**
   * Returns all connectable items of the net with number p_net_no, which can be reached recursively from this item via normal contacts. if p_net_no {@literal <}= 0, the net number is ignored.
   */
