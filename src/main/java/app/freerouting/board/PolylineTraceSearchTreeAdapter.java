 ...
 *
 * <p>The adapter is intentionally stateless. Search-tree ownership remains with
 * {@link BasicBoard}, and all operations retain the existing manager call order.
 */
final class PolylineTraceSearchTreeAdapter {
   ...
   *
   * <p>This order is significant: the old entries are removed before the geometry and derived
   * data are changed, and the new geometry is inserted only after both changes are complete.
   */
