...
public class ShapeTraceEntries {
  ...
  public final Collection<Via> shoveViaList;
   ...
   * list.
   */
  public PolylineTrace nextSubstituteTracePiece() {
  ...
  public int substituteTraceCount() {
   ...
   * ignored
   */
  public void cutoutTraces(Collection<Item> itemList) {
    for (Item currentItem : itemList) {
