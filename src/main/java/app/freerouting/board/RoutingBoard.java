...
public class RoutingBoard extends BasicBoard implements java.io.Serializable
{
     ...
     */
    public AutorouteEngine.AutorouteResult autoroute(Item p_item, app.freerouting.interactive.Settings p_settings, int p_via_costs, Stoppable p_stoppable_thread, TimeLimit p_time_limit)
    {
     ...
     *  Returns an enum of type AutorouteEngine.AutorouteResult
     */
    public AutorouteEngine.AutorouteResult fanout(Pin p_pin, app.freerouting.interactive.Settings p_settings, int p_ripup_costs,
