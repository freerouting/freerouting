...
public class Via extends DrillItem implements java.io.Serializable
{
    ...
    public app.freerouting.autoroute.ExpansionDrill get_autoroute_drill_info(ShapeSearchTree p_autoroute_tree)
    {
        if (this.autoroute_drill_info == null)
        {
            ...
            this.autoroute_drill_info =
                    new app.freerouting.autoroute.ExpansionDrill(curr_drill_shape, this.get_center(), this.first_layer(), this.last_layer());
    ...
    transient private app.freerouting.autoroute.ExpansionDrill autoroute_drill_info = null;
}
