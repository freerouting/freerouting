...
public abstract class PrintableShape {
  ...
  public static class Circle extends PrintableShape {
  ...
  public static class Rectangle extends PrintableShape {
  ...
  public static class Polygon extends PrintableShape {
