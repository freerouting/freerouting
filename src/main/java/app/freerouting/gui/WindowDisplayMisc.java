...
public class WindowDisplayMisc extends BoardSavableSubWindow {
  ...
  public WindowDisplayMisc(BoardFrame p_board_frame) {
    ...
    javax.swing.JLabel cursor_label =
        new javax.swing.JLabel("   " + resources.getString("cross_hair_cursor"));
    gridbag_constraints.gridwidth = java.awt.GridBagConstraints.RELATIVE;
    ...
    javax.swing.JLabel rotation_label =
        new javax.swing.JLabel("   " + resources.getString("rotation"));
    gridbag_constraints.gridwidth = java.awt.GridBagConstraints.RELATIVE;
    ...
    javax.swing.JLabel mirroring_label =
        new javax.swing.JLabel("   " + resources.getString("board_mirroring"));
    gridbag_constraints.gridwidth = java.awt.GridBagConstraints.RELATIVE;
    ...
    javax.swing.JLabel auto_layer_dim_label =
        new javax.swing.JLabel(resources.getString("layer_dimming"));
  ...
  private class RotationNoneListener implements java.awt.event.ActionListener {
    public void actionPerformed(java.awt.event.ActionEvent p_evt) {
      app.freerouting.boardgraphics.CoordinateTransform coordinate_transform =
  ...
  private class MirrorNoneListener implements java.awt.event.ActionListener {
    public void actionPerformed(java.awt.event.ActionEvent p_evt) {
      ...
      app.freerouting.geometry.planar.FloatPoint old_viewport_center =
