...
public class WindowRouteParameter extends BoardSavableSubWindow {
  ...
  public WindowRouteParameter(BoardFrame p_board_frame) {
    ...
    javax.swing.JLabel trace_widths_label =
        new javax.swing.JLabel(resources.getString("rule_selection"));
    gridbag_constraints.gridwidth = java.awt.GridBagConstraints.RELATIVE;
    gridbag_constraints.gridheight = 2;
    ...
    this.drag_component_check_box =
        new javax.swing.JCheckBox(resources.getString("drag_components_enabled"));
    ...
    this.drag_component_check_box.setToolTipText(
        resources.getString("drag_components_enabled_tooltip"));
    main_panel.add(drag_component_check_box, gridbag_constraints);

    // add check box for via snap to smd center

    this.via_snap_to_smd_center_check_box =
        new javax.swing.JCheckBox(resources.getString("via_snap_to_smd_center"));
    ...
    this.via_snap_to_smd_center_check_box.setToolTipText(
        resources.getString("via_snap_to_smd_center_tooltip"));
    main_panel.add(via_snap_to_smd_center_check_box, gridbag_constraints);

    // add check box for hilighting the routing obstacle

    this.hilight_routing_obstacle_check_box =
        new javax.swing.JCheckBox(resources.getString("hilight_routing_obstacle"));
    ...
    this.hilight_routing_obstacle_check_box.setToolTipText(
    ...
    this.ignore_conduction_check_box =
        new javax.swing.JCheckBox(resources.getString("ignore_conduction_areas"));
    ...
    this.ignore_conduction_check_box.setToolTipText(
        resources.getString("ignore_conduction_areas_tooltip"));
    ...
    this.restrict_pin_exit_directions_check_box =
        new javax.swing.JCheckBox(resources.getString("restrict_pin_exit_directions"));
    this.restrict_pin_exit_directions_check_box.addActionListener(
        new RestrictPinExitDirectionsListener());
    gridbag.setConstraints(restrict_pin_exit_directions_check_box, gridbag_constraints);
    this.restrict_pin_exit_directions_check_box.setToolTipText(
        resources.getString("restrict_pin_exit_directions_tooltip"));
    main_panel.add(restrict_pin_exit_directions_check_box, gridbag_constraints);

    gridbag_constraints.gridwidth = java.awt.GridBagConstraints.RELATIVE;
    javax.swing.JLabel pin_exit_edge_to_turn_label =
        new javax.swing.JLabel(resources.getString("pin_pad_to_turn_gap"));
    ...
    gridbag_constraints.gridwidth = java.awt.GridBagConstraints.RELATIVE;
    javax.swing.JLabel pull_tight_region_label =
        new javax.swing.JLabel(resources.getString("pull_tight_region"));
    ...
    javax.swing.JButton detail_button =
        new javax.swing.JButton(resources.getString("detail_parameter"));
  ...
  public void refresh() {
    ...
    } else if (snap_angle == app.freerouting.board.AngleRestriction.FORTYFIVE_DEGREE) {
    ...
    this.drag_component_check_box.setSelected(
        this.board_handling.settings.get_drag_components_enabled());
    this.via_snap_to_smd_center_check_box.setSelected(
        this.board_handling.settings.get_via_snap_to_smd_center());
    this.ignore_conduction_check_box.setSelected(
        this.board_handling.get_routing_board().rules.get_ignore_conduction());
    this.hilight_routing_obstacle_check_box.setSelected(
  ...
  private class SnapAngle90Listener implements java.awt.event.ActionListener {
    public void actionPerformed(java.awt.event.ActionEvent p_evt) {
      ...
      Collection<app.freerouting.board.Trace> trace_list =
          board_handling.get_routing_board().get_traces();
      boolean free_angle_traces_found = false;
      for (app.freerouting.board.Trace curr_trace : trace_list) {
        if (curr_trace instanceof app.freerouting.board.PolylineTrace) {
          if (!((app.freerouting.board.PolylineTrace) curr_trace).polyline().is_orthogonal()) {
  ...
  private class SnapAngle45Listener implements java.awt.event.ActionListener {
    public void actionPerformed(java.awt.event.ActionEvent p_evt) {
      ...
      for (app.freerouting.board.Trace curr_trace : trace_list) {
        if (curr_trace instanceof app.freerouting.board.PolylineTrace) {
          if (!((app.freerouting.board.PolylineTrace) curr_trace)
              .polyline()
