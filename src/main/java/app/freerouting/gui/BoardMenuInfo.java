...
public class BoardMenuInfo extends JMenu {
  ...
  public static BoardMenuInfo get_instance(BoardFrame p_board_frame) {
    ...
    package_window.addActionListener(
        evt -> info_menu.board_frame.packages_window.setVisible(true));
    ...
    padstacks_window.addActionListener(
        evt -> info_menu.board_frame.padstacks_window.setVisible(true));
    ...
    components_window.addActionListener(
        evt -> info_menu.board_frame.components_window.setVisible(true));
    ...
    incompletes_window.addActionListener(
        evt -> info_menu.board_frame.incompletes_window.setVisible(true));
    ...
    length_violations_window.addActionListener(
        evt -> info_menu.board_frame.length_violations_window.setVisible(true));
    ...
    clearance_violations_window.addActionListener(
        evt -> info_menu.board_frame.clearance_violations_window.setVisible(true));
    ...
    unconnected_route_window.addActionListener(
        evt -> info_menu.board_frame.unconnected_route_window.setVisible(true));
    ...
    route_stubs_window.addActionListener(
        evt -> info_menu.board_frame.route_stubs_window.setVisible(true));
