...
public final class BoardMenuInfo extends JMenu {
  ...
  public static BoardMenuInfo get_instance(BoardFrame p_board_frame) {
    ...
    info_packages_menuitem.addActionListener(
        _ -> info_menu.board_frame.packages_window.setVisible(true));
    info_packages_menuitem.addActionListener(
        _ -> FRAnalytics.buttonClicked("info_packages_menuitem", info_packages_menuitem.getText()));
    ...
    info_padstacks_menuitem.addActionListener(
        _ -> info_menu.board_frame.padstacks_window.setVisible(true));
    info_padstacks_menuitem.addActionListener(
        _ ->
            FRAnalytics.buttonClicked(
                "info_padstacks_menuitem", info_padstacks_menuitem.getText()));
    ...
    info_components_menuitem.addActionListener(
        _ -> info_menu.board_frame.components_window.setVisible(true));
    info_components_menuitem.addActionListener(
        _ ->
            FRAnalytics.buttonClicked(
                "info_components_menuitem", info_components_menuitem.getText()));
    ...
    info_incompletes_menuitem.addActionListener(
        _ -> info_menu.board_frame.incompletes_window.setVisible(true));
    info_incompletes_menuitem.addActionListener(
        _ ->
            FRAnalytics.buttonClicked(
                "info_incompletes_menuitem", info_incompletes_menuitem.getText()));
    ...
    info_length_violations_menuitem.addActionListener(
        _ -> info_menu.board_frame.length_violations_window.setVisible(true));
    info_length_violations_menuitem.addActionListener(
        _ ->
            FRAnalytics.buttonClicked(
                "info_length_violations_menuitem", info_length_violations_menuitem.getText()));
    ...
    info_clearance_violations_menuitem.addActionListener(
        _ -> info_menu.board_frame.clearance_violations_window.setVisible(true));
    info_clearance_violations_menuitem.addActionListener(
        _ ->
            FRAnalytics.buttonClicked(
                "info_clearance_violations_menuitem",
                info_clearance_violations_menuitem.getText()));
    ...
    info_unconnected_routes_menuitem.addActionListener(
        _ -> info_menu.board_frame.unconnected_route_window.setVisible(true));
    info_unconnected_routes_menuitem.addActionListener(
        _ ->
            FRAnalytics.buttonClicked(
                "info_unconnected_routes_menuitem", info_unconnected_routes_menuitem.getText()));
    ...
    info_route_stubs_menuitem.addActionListener(
        _ -> info_menu.board_frame.route_stubs_window.setVisible(true));
    info_route_stubs_menuitem.addActionListener(
        _ ->
            FRAnalytics.buttonClicked(
                "info_route_stubs_menuitem", info_route_stubs_menuitem.getText()));
