...
public class WindowAutorouteParameter extends BoardSavableSubWindow
{
    ...
    public WindowAutorouteParameter(BoardFrame p_board_frame)
    {
        ...
        java.util.ResourceBundle resources =
                java.util.ResourceBundle.getBundle("app.freerouting.gui.WindowAutorouteParameter", p_board_frame.get_locale());
        ...
        app.freerouting.board.LayerStructure layer_structure = board_handling.get_routing_board().layer_structure;
    ...
    public void refresh()
    {
        app.freerouting.interactive.AutorouteSettings settings = this.board_handling.settings.autoroute_settings;
        app.freerouting.board.LayerStructure layer_structure = this.board_handling.get_routing_board().layer_structure;
    ...
    private class FanoutListener implements java.awt.event.ActionListener
    {
        ...
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            app.freerouting.interactive.AutorouteSettings autoroute_settings = board_handling.settings.autoroute_settings;
