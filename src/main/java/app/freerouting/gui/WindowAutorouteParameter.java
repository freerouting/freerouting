...
public class WindowAutorouteParameter extends BoardSavableSubWindow {
  ...
  public WindowAutorouteParameter(BoardFrame p_board_frame) {
    ...
    javax.swing.JLabel preferred_direction_label =
        new javax.swing.JLabel(resources.getString("preferred_direction"));
    ...
    javax.swing.JLabel vias_allowed_label =
        new javax.swing.JLabel(resources.getString("vias_allowed"));
