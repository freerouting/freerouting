...
public class WindowSelectParameter extends BoardSavableSubWindow
{
    ...
    public WindowSelectParameter(BoardFrame p_board_frame)
    {
        ...
        java.util.ResourceBundle resources = 
                java.util.ResourceBundle.getBundle("app.freerouting.gui.WindowSelectParameter", p_board_frame.get_locale());
    ...
    public void refresh()
    {
        ...
        app.freerouting.board.LayerStructure layer_structure = this.board_handling.get_routing_board().layer_structure;
        app.freerouting.board.Layer current_layer = layer_structure.arr[this.board_handling.settings.get_layer()];
