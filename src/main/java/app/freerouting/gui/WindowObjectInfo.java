 ...
 */
public class WindowObjectInfo extends BoardTemporarySubWindow implements app.freerouting.board.ObjectInfoPanel
{
    /**
     ...
     */
    public static void display(Collection<app.freerouting.board.Item> p_item_list,
                               BoardFrame p_board_frame, app.freerouting.board.CoordinateTransform p_coordinate_transform, java.awt.Point p_location)
    {
    ...
    {
        app.freerouting.board.PrintableShape transformed_shape = this.coordinate_transform.board_to_user(p_shape, p_locale);
     ...
     */
    public boolean append_items( String p_button_name, String p_window_title, java.util.Collection<app.freerouting.board.Item> p_items)
    {
        java.util.Collection<WindowObjectInfo.Printable> object_list = new java.util.LinkedList<WindowObjectInfo.Printable>();
