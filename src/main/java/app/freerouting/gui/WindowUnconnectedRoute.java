...
public class WindowUnconnectedRoute extends WindowObjectListWithFilter
{
    ...
    {
        super(p_board_frame);
        this.resources = java.util.ResourceBundle.getBundle("app.freerouting.gui.CleanupWindows", p_board_frame.get_locale());
    ...
    protected void fill_list()
    {
        ...
        {
            if (!(curr_item instanceof app.freerouting.board.Trace || curr_item instanceof app.freerouting.board.Via))
            {
                continue;
            }
            ...
            for (Item curr_connnected_item : curr_connected_set)
            {
                ...
                if (!(curr_connnected_item instanceof app.freerouting.board.Trace || curr_connnected_item instanceof app.freerouting.board.Via))
                {
            ...
            if (!terminal_item_found)
            {
                ...
                {
                    app.freerouting.rules.Net curr_net = routing_board.rules.nets.get(curr_item.get_net_no(0));
                    if (curr_net != null)
                    {
    ...
    protected void select_instances()
    {
        ...
        Set<app.freerouting.board.Item> selected_items = new java.util.TreeSet<app.freerouting.board.Item>();
