 ...
 *
 * <p>Background code only sees {@link WorkspacePort}; all Swing-facing mutations are centralized
 * here and are generation-checked at execution time.
 */
public final class WorkspacePortAdapter implements WorkspacePort {
  ...
  private boolean isCurrentGeneration(WorkspaceGeneration generation) {
