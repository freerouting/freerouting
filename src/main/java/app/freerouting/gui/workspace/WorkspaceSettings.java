 ...
 * {@code null}; use {@link app.freerouting.management.BoardManager#getRoutingBoard()} or check for
 * {@link WorkspaceContract} to safely interact with manager implementations.
 *
 ...
 */
public class WorkspaceSettings extends GuiSettingsSource implements Serializable {
  ...
  private static volatile WorkspaceSettings instance;
  ...
  public WorkspaceSettings(RoutingBoard board) {
    super(null);
  ...
  public WorkspaceSettings(RoutingBoard board, RouterSettings settings) {
    this(board);
    setSettings(settings);
  }

  /** Creates a copy of another interactive settings instance. */
  public WorkspaceSettings(WorkspaceSettings settings) {
    super(null);
   ...
   * WorkspaceContract#getWorkspaceSettings()} after verifying {@code manager instanceof
   * WorkspaceContract} to safely obtain the instance.
   *
   ...
   * @return the singleton {@link WorkspaceSettings} instance
   */
  public static WorkspaceSettings getOrCreate(RoutingBoard board, RouterSettings routerSettings) {
    if (instance == null) {
      synchronized (WorkspaceSettings.class) {
        if (instance == null) {
          instance = new WorkspaceSettings(board, routerSettings);
        }
      }
   ...
   * @return the singleton {@link WorkspaceSettings} instance
   */
  public static WorkspaceSettings getOrCreate(RoutingBoard board) {
   ...
   */
  public static WorkspaceSettings reset(RoutingBoard board, RouterSettings routerSettings) {
    synchronized (WorkspaceSettings.class) {
      instance = new WorkspaceSettings(board, routerSettings);
      return instance;
    }
   ...
   * @return the new singleton instance
   */
  public static WorkspaceSettings reset(RoutingBoard board) {
   ...
   *
   * <p>Used after binary deserialisation where the {@link WorkspaceSettings} object is read
  ...
  private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
    ...
    if (this.itemSelectionFilter == null) {
      FRLogger.warn("WorkspaceSettings.readObject: itemSelectionFilter is null");
