...
public class DesignFile
{
     ...
     */
    private boolean write_rules_file(String p_design_name, app.freerouting.interactive.BoardHandling p_board_handling)
    {
    ...
    public static boolean read_rules_file(String p_design_name, String p_parent_name, String rules_file_name,
                                          app.freerouting.interactive.BoardHandling p_board_handling, boolean p_is_web_start, String p_confirm_message)
    {
