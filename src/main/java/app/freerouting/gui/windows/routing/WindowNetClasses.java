...
public class WindowNetClasses extends BoardSavableSubWindow {
  ...
  public static boolean canRemoveNetClass(int rowCount, int selectedRow) {
    return rowCount > 1 && selectedRow >= 0;
  }

  public static void applyShoveFixedSelection(NetClass netClass, boolean shoveFixed) {
    netClass.setShoveFixed(shoveFixed);
    netClass.setPullTight(!shoveFixed);
  }

  public static void applyAutorouterIgnoreSelection(
      NetClass netClass, boolean ignoredByAutorouter) {
