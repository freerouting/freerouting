 ...
 */
final class BoardWindowLayout {

  private final BoardFrame boardFrame;
  private final Locale locale;
  private final String freeroutingVersion;

  BoardWindowLayout(BoardFrame boardFrame, Locale locale, String freeroutingVersion) {
    this.boardFrame = boardFrame;
    this.locale = locale;
    this.freeroutingVersion = freeroutingVersion;
  }

  void allocatePermanentSubwindows() {
    allocateEssentialSubwindows();
    allocateRemainingSubwindows();
  }

  void allocateEssentialSubwindows() {
  ...
  void allocateRemainingSubwindows() {
  ...
  void initializeWindows(boolean showEssentialImmediately) {
    allocateEssentialSubwindows();
  ...
  void positionRemainingSubwindows() {
  ...
  void disposePermanentSubwindows() {
  ...
  BoardSavableSubWindow[] getPermanentSubwindows() {
