 ...
 */
final class BoardExportActions {

  private final BoardFrame boardFrame;

  BoardExportActions(BoardFrame boardFrame) {
    this.boardFrame = boardFrame;
  }

  boolean saveAsBinary(OutputStream outputStream) throws Exception {
  ...
  boolean saveAsSpecctraSessionSes(File outputFile, String designName) {
    if (outputFile == null) {
      return false;
    }
  ...
  boolean saveAsKiCadJson(File outputFile, String designName) {
    if (outputFile == null) {
      return false;
    }
  ...
  File showSaveAsDialog(String defaultDirectory, BoardFileDetails output) {
  ...
  void saveAsEagleScriptScr(File outputFile, String designName) {
    ...
    try (OutputStream outputStream = new FileOutputStream(outputFile)) {
      if (boardHandling.saveSpecctraSessionSesAsEagleScriptScr(
  ...
  boolean saveAsSpecctraDesignDsn(File outputFile, String designName, boolean compatibilityMode) {
    if (outputFile == null) {
      return false;
    }
