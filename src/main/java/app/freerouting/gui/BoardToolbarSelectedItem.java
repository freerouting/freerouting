...
class BoardToolbarSelectedItem extends JToolBar {
  ...
  BoardToolbarSelectedItem(BoardFrame p_board_frame) {
    ...
    toolbar_cancel_button
        .addActionListener(_ -> FRAnalytics.buttonClicked("toolbar_cancel_button", toolbar_cancel_button.getText()));
    ...
    toolbar_info_button
        .addActionListener(_ -> FRAnalytics.buttonClicked("toolbar_info_button", toolbar_info_button.getText()));
    ...
    toolbar_delete_button
        .addActionListener(_ -> FRAnalytics.buttonClicked("toolbar_delete_button", toolbar_delete_button.getText()));
    ...
    toolbar_cutout_button
        .addActionListener(_ -> FRAnalytics.buttonClicked("toolbar_cutout_button", toolbar_cutout_button.getText()));
    ...
    toolbar_fix_button
        .addActionListener(_ -> FRAnalytics.buttonClicked("toolbar_fix_button", toolbar_fix_button.getText()));
    ...
    toolbar_unfix_button
        .addActionListener(_ -> FRAnalytics.buttonClicked("toolbar_unfix_button", toolbar_unfix_button.getText()));
    ...
    toolbar_autoroute_button.addActionListener(
        _ -> FRAnalytics.buttonClicked("toolbar_autoroute_button", toolbar_autoroute_button.getText()));
    ...
    toolbar_tidy_button
        .addActionListener(_ -> FRAnalytics.buttonClicked("toolbar_tidy_button", toolbar_tidy_button.getText()));
    ...
    toolbar_clearance_class_button.addActionListener(
        _ -> FRAnalytics.buttonClicked("toolbar_clearance_class_button", toolbar_clearance_class_button.getText()));
    ...
    toolbar_whole_connected_sets_button
        .addActionListener(_ -> board_frame.board_panel.board_handling.extend_selection_to_whole_connected_sets());
    ...
    toolbar_whole_connections_button.addActionListener(
        _ -> FRAnalytics.buttonClicked("toolbar_whole_connections_button", toolbar_whole_connections_button.getText()));
    ...
    toolbar_new_net_button
        .addActionListener(_ -> FRAnalytics.buttonClicked("toolbar_new_net_button", toolbar_new_net_button.getText()));
    ...
    toolbar_new_group_button
        .addActionListener(_ -> board_frame.board_panel.board_handling.assign_selected_to_new_group());
    toolbar_new_group_button.addActionListener(
        _ -> FRAnalytics.buttonClicked("toolbar_new_group_button", toolbar_new_group_button.getText()));
    ...
    toolbar_display_selection_button.addActionListener(
        _ -> FRAnalytics.buttonClicked("toolbar_display_selection_button", toolbar_display_selection_button.getText()));
  ...
  private void assign_clearance_class() {
    ...
    ClearanceMatrix clearance_matrix = board_frame.board_panel.board_handling
        .get_routing_board().rules.clearance_matrix;
    ...
    Object assign_clearance_class_dialog = JOptionPane.showInputDialog(null, tm.getText("select_clearance_class"),
        tm.getText("assign_clearance_class"), JOptionPane.INFORMATION_MESSAGE, null,
