...
public class BoardMenuFile extends javax.swing.JMenu
{
    ...
    public void add_design_dependent_items()
    {
        ...
        if ((routing_board.get_test_level() != app.freerouting.board.TestLevel.RELEASE_VERSION || !host_cad_is_eagle))
        {
    ...
    private BoardMenuFile(BoardFrame p_board_frame, boolean p_session_file_option)
    {
        ...
        resources = java.util.ResourceBundle.getBundle("app.freerouting.gui.BoardMenuFile", p_board_frame.get_locale());
    }
