 ...
 */
final class WindowAutorouteParameterState {
  ...
  static Timeout parseTimeout(String timeoutString) {
    Long parsedSeconds =
  ...
  static String buildTimeout(long hours, long minutes, long seconds) {
  ...
  static String formatTimeout(long totalSeconds) {
  ...
  record Timeout(long hours, long minutes, long seconds, long totalSeconds) {}
}
