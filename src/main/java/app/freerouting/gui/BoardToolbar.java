...
class BoardToolbar extends javax.swing.JPanel
{
    ...
    BoardToolbar(BoardFrame p_board_frame)
    {
        ...
        unit_combo_box.addActionListener(new java.awt.event.ActionListener()
        {
            public void actionPerformed(java.awt.event.ActionEvent evt)
            {
                app.freerouting.board.Unit new_unit = (app.freerouting.board.Unit) unit_combo_box.getSelectedItem();
    ...
    {
        app.freerouting.interactive.InteractiveState interactive_state = this.board_frame.board_panel.board_handling.get_interactive_state();
