...
public class WindowSnapshot extends BoardSavableSubWindow
{
    ...
    void goto_selected()
    {
        ...
        if (index >= 0 && list_model.getSize() > index)
        {
            ...
            if (curr_snapshot.settings.get_snapshot_attributes().display_region)
            {
                ...
                {
                    board_handling.graphics_context.coordinate_transform = new app.freerouting.boardgraphics.CoordinateTransform(curr_snapshot.graphics_context.coordinate_transform);
    ...
    private class AddListener implements java.awt.event.ActionListener
    {
        ...
        {
            app.freerouting.interactive.SnapShot new_snapshot = app.freerouting.interactive.SnapShot.get_instance(name_field.getText(), board_frame.board_panel.board_handling);
    ...
    {
        public SavedAttributes(javax.swing.DefaultListModel<app.freerouting.interactive.SnapShot> p_list_model, int p_snapshot_count, java.awt.Point p_location, boolean p_is_visible)
        {
