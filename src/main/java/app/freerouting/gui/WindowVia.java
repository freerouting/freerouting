...
public class WindowVia extends BoardSavableSubWindow
{
    ...
    private class ShowPadstacksListener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            app.freerouting.library.BoardLibrary board_library = board_frame.board_panel.board_handling.get_routing_board().library;
    ...
    private class AddPadstackListener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            app.freerouting.board.BasicBoard pcb = board_frame.board_panel.board_handling.get_routing_board();
            ...
            {
                Layer[] possible_start_layers = new  app.freerouting.board.Layer[pcb.layer_structure.arr.length - 1];
            ...
            if (!layers_selected)
            {
                ...
                Layer[] possible_end_layers = new  app.freerouting.board.Layer[pcb.layer_structure.arr.length - first_possible_end_layer_no];
            ...
            app.freerouting.geometry.planar.ConvexShape[] padstack_shapes = new app.freerouting.geometry.planar.ConvexShape[pcb.layer_structure.arr.length];
            app.freerouting.board.CoordinateTransform coordinate_transform = board_frame.board_panel.board_handling.coordinate_transform;
            ...
            for (int i = from_layer_no; i <= to_layer_no; ++i)
            {
                ...
                if (circle_radius > 0)
                {
                    padstack_shapes[i] = new  app.freerouting.geometry.planar.Circle(app.freerouting.geometry.planar.Point.ZERO, circle_radius);
                    shape_exists = true;
                }
            }
            if (!shape_exists)
            ...
            app.freerouting.library.Padstack new_padstack = pcb.library.padstacks.add(padstack_name, padstack_shapes, true, true);
    ...
    private class RemovePadstackListener implements java.awt.event.ActionListener
    {
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            app.freerouting.library.Padstack selected_padstack = (app.freerouting.library.Padstack)selected_value;
    ...
    private class ShowViasListener implements java.awt.event.ActionListener
    {
        ...
        {
            java.util.Collection<WindowObjectInfo.Printable> object_list = new java.util.LinkedList<WindowObjectInfo.Printable>();
            app.freerouting.rules.ViaInfos via_infos = board_frame.board_panel.board_handling.get_routing_board().rules.via_infos;
