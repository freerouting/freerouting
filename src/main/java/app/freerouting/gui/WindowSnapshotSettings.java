...
public class WindowSnapshotSettings extends BoardSavableSubWindow {
  ...
  public WindowSnapshotSettings(BoardFrame p_board_frame) {
    ...
    this.object_visibility_check_box =
        new javax.swing.JCheckBox(resources.getString("object_visibility"));
    ...
    this.layer_visibility_check_box =
        new javax.swing.JCheckBox(resources.getString("layer_visibility"));
    ...
    this.display_region_check_box =
        new javax.swing.JCheckBox(resources.getString("display_region"));
    ...
    this.interactive_state_check_box =
        new javax.swing.JCheckBox(resources.getString("interactive_state"));
    ...
    this.selection_layers_check_box =
        new javax.swing.JCheckBox(resources.getString("selection_layers"));
    ...
    this.selectable_items_check_box =
        new javax.swing.JCheckBox(resources.getString("selectable_items"));
    ...
    this.rule_selection_check_box =
        new javax.swing.JCheckBox(resources.getString("rule_selection"));
    ...
    this.manual_rule_settings_check_box =
        new javax.swing.JCheckBox(resources.getString("manual_rule_settings"));
    ...
    this.push_and_shove_enabled_check_box =
        new javax.swing.JCheckBox(resources.getString("push&shove_enabled"));
    ...
    this.pull_tight_region_check_box =
        new javax.swing.JCheckBox(resources.getString("pull_tight_region"));
    ...
    this.component_grid_check_box =
        new javax.swing.JCheckBox(resources.getString("component_grid"));
    ...
    this.info_list_filter_check_box =
        new javax.swing.JCheckBox(resources.getString("info_list_selections"));
