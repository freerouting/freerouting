...
public class WindowNetClasses extends BoardSavableSubWindow {
  ...
  public WindowNetClasses(BoardFrame p_board_frame) {
    ...
    final javax.swing.JButton add_class_button =
        new javax.swing.JButton(resources.getString("add"));
    ...
    final javax.swing.JButton remove_class_button =
    ...
    final javax.swing.JButton assign_button =
        new javax.swing.JButton(resources.getString("assign"));
    ...
    final javax.swing.JButton select_button =
        new javax.swing.JButton(resources.getString("select"));
    ...
    final javax.swing.JButton contained_nets_button =
        new javax.swing.JButton(resources.getString("show_nets"));
  ...
  private void add_table() {
    ...
    this.table
        ...
        .setCellEditor(new javax.swing.DefaultCellEditor(via_rule_combo_box));
    this.table
        .getColumnModel()
        .getColumn(ColumnName.ON_LAYER.ordinal())
        .setCellEditor(new javax.swing.DefaultCellEditor(layer_combo_box));
  }
  ...
  private class RemoveNetClassListener implements java.awt.event.ActionListener {
    ...
    public void actionPerformed(java.awt.event.ActionEvent p_evt) {
      ...
      for (int i = 1; i < board_rules.nets.max_net_no(); ++i) {
        app.freerouting.rules.Net curr_net = board_rules.nets.get(i);
  ...
  private class SelectClassesListener implements java.awt.event.ActionListener {
    ...
    public void actionPerformed(java.awt.event.ActionEvent p_evt) {
      ...
      app.freerouting.rules.Nets nets = routing_board.rules.nets;
