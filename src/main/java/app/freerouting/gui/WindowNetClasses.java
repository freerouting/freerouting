...
public class WindowNetClasses extends BoardSavableSubWindow
{
    ...
    {
        this.resources = java.util.ResourceBundle.getBundle("app.freerouting.gui.WindowNetClasses", p_board_frame.get_locale());
        ...
        app.freerouting.board.BasicBoard routing_board = p_board_frame.board_panel.board_handling.get_routing_board();
    ...
    private class SelectClassesListener implements java.awt.event.ActionListener
    {
        ...
        public void actionPerformed(java.awt.event.ActionEvent p_evt)
        {
            ...
            for (app.freerouting.board.Item curr_item : board_items)
            {
                ...
                {
                    app.freerouting.rules.NetClass curr_net_class = nets.get(curr_item.get_net_no(i)).get_class();
