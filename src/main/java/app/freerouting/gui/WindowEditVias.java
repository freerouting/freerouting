...
public class WindowEditVias extends BoardSavableSubWindow {
  ...
  public WindowEditVias(BoardFrame p_board_frame) {
    ...
    rules_vias_vias_edit_add_button.addActionListener(
        _ ->
            FRAnalytics.buttonClicked(
                "rules_vias_vias_edit_add_button", rules_vias_vias_edit_add_button.getText()));
    ...
    rules_vias_vias_edit_remove_button.addActionListener(
        _ ->
            FRAnalytics.buttonClicked(
                "rules_vias_vias_edit_remove_button",
                rules_vias_vias_edit_remove_button.getText()));
    ...
    public void set_values() {
      ...
      for (int i = 0; i < data.length; i++) {
        ...
        this.data[i][ColumnName.CLEARANCE_CLASS.ordinal()] =
            board_rules.clearance_matrix.get_name(curr_via.get_clearance_class());
