...
public class WindowManualRules extends BoardSavableSubWindow
{
    ...
    public WindowManualRules(BoardFrame p_board_frame)
    {
        ...
        java.util.ResourceBundle resources =
                java.util.ResourceBundle.getBundle("app.freerouting.gui.WindowManualRule", p_board_frame.get_locale());
    ...
    public void refresh()
    {
        ...
        javax.swing.ComboBoxModel<app.freerouting.rules.ViaRule> new_model = new javax.swing.DefaultComboBoxModel<>(routing_board.rules.via_rules);
        this.via_rule_combo_box.setModel(new_model);
        app.freerouting.rules.ClearanceMatrix clearance_matrix = board_handling.get_routing_board().rules.clearance_matrix;
