...
public class WindowClearanceMatrix extends BoardSavableSubWindow {
  ...
  public WindowClearanceMatrix(BoardFrame p_board_frame) {
    ...
    final javax.swing.JButton add_class_button =
        new javax.swing.JButton(resources.getString("add_class"));
  ...
  private javax.swing.JPanel add_clearance_table(BoardFrame p_board_frame) {
    ...
    javax.swing.table.DefaultTableCellRenderer first_colunn_renderer =
  ...
  private void add_class() {
    ...
    final app.freerouting.board.BasicBoard routing_board =
        this.board_frame.board_panel.board_handling.get_routing_board();
    final app.freerouting.rules.ClearanceMatrix clearance_matrix =
        ...
        if (clearance_matrix.is_equal(i, j)) {
          ...
          int selected_option =
              javax.swing.JOptionPane.showConfirmDialog(
                  this, message, null, javax.swing.JOptionPane.YES_NO_OPTION);
          if (selected_option == javax.swing.JOptionPane.YES_OPTION) {
            java.util.Collection<app.freerouting.board.Item> board_items =
  ...
  private class ClearanceTableModel extends javax.swing.table.AbstractTableModel
    ...
    public void setValueAt(Object p_value, int p_row, int p_col) {
      ...
      app.freerouting.interactive.BoardHandling board_handling =
          board_frame.board_panel.board_handling;
      app.freerouting.datastructures.UndoableObjects item_list =
      ...
      for (; ; ) {
        app.freerouting.board.Item curr_item =
            (app.freerouting.board.Item) item_list.read_object(it);
        if (curr_item == null) {
          break;
        }
        ...
        for (int j = 0; j < clearance_matrix.get_class_count(); ++j) {
          if (p_layer == ComboBoxLayer.ALL_LAYER_INDEX) {
            ...
            Float curr_table_value =
                (float)
                    board_handling.coordinate_transform.board_to_user(
                        clearance_matrix.value(i, j, p_layer));
            this.data[i][j + 1] = curr_table_value;
          }
        }
      }
