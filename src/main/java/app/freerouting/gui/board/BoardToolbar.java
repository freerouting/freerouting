...
public class BoardToolbar extends JPanel {
  ...
  public BoardToolbar(BoardFrame boardFrame, boolean disableSelectMode) {
    ...
    toolbarAutorouteButton.addActionListener(
        _ -> {
          ...
          app.freerouting.board.facade.RoutingBoard routingBoard =
    ...
    deleteAllTracksButton.addActionListener(
        _ -> {
          ...
          boardFrame.screenMessages.setBoardScore(
              boardStatistics.getRouterScore(boardFrame.routingJob.routerSettings),
   ...
   */
  public static void setComponentOnlyEnabled(Container toolbar, boolean enabled) {
    String[] locators = {
  ...
  public void setModeSelectionPanelValue(EditorStateHandle editorState) {
    if (editorState == null) {
      return;
    }
