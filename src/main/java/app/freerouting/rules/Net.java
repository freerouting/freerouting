 ...
 */
public class Net implements Comparable<Net>, app.freerouting.board.ObjectInfoPanel.Printable, java.io.Serializable
{
    ...
    {
        java.util.Collection<app.freerouting.board.Pin> result = new java.util.LinkedList<app.freerouting.board.Pin>();
        app.freerouting.board.BasicBoard board = this.net_list.get_board();
        java.util.Iterator<UndoableObjects.UndoableObjectNode> it = board.item_list.start_read_object();
        for (;;)
        {
    ...
    {
        java.util.Collection<app.freerouting.board.Item> result = new java.util.LinkedList<app.freerouting.board.Item>();
        app.freerouting.board.BasicBoard board = this.net_list.get_board();
        java.util.Iterator<UndoableObjects.UndoableObjectNode> it = board.item_list.start_read_object();
        for (;;)
        {
