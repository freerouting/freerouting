...
public class BoardRules implements java.io.Serializable
{
     ...
     */
    public BoardRules(app.freerouting.board.LayerStructure p_layer_structure, ClearanceMatrix p_clearance_matrix)
    {
     ...
     * to p_to_no.
     */
    public void change_clearance_class_no(int p_from_no, int p_to_no, java.util.Collection<app.freerouting.board.Item> p_board_items)
    {
     ...
     */
    public boolean remove_clearance_class(int p_index, java.util.Collection<app.freerouting.board.Item> p_board_items)
    {
        for(app.freerouting.board.Item curr_item : p_board_items)
        {
    ...
    public void set_trace_angle_restriction(app.freerouting.board.AngleRestriction p_angle_restriction)
    {
