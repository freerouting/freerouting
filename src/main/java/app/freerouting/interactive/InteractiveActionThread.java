...
/**
 * Used for running an interactive action in a separate thread, that can be stopped by the user. This typically represents an action that is triggered by the user on the GUI, such as autorouting,
 * fanout, etc.
 */
