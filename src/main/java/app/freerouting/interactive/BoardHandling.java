...
public class BoardHandling extends BoardHandlingHeadless
{
    ...
    public BoardHandling(BoardPanel p_panel, java.util.Locale p_locale, boolean p_save_intermediate_stages, float p_optimization_improvement_threshold)
    {
        ...
        this.resources = java.util.ResourceBundle.getBundle("app.freerouting.interactive.BoardHandling", p_locale);
    }
    ...
    public void create_board(IntBox p_bounding_box, LayerStructure p_layer_structure,
                             ...
                             BoardRules p_rules, app.freerouting.board.Communication p_board_communication, TestLevel p_test_level)
    {
    ...
    public DsnFile.ReadResult import_design(java.io.InputStream p_design,
                                            ...
                                            app.freerouting.datastructures.IdNoGenerator p_item_id_no_generator, TestLevel p_test_level)
    {
        if (p_design == null)
        {
