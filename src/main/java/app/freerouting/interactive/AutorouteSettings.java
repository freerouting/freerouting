...
public class AutorouteSettings implements Serializable
{
  ...
  public AutorouteSettings(AutorouteSettings p_settings)
  {
    ...
    System.arraycopy(p_settings.preferred_direction_is_horizontal_arr, 0, this.preferred_direction_is_horizontal_arr, 0, preferred_direction_is_horizontal_arr.length);
