...
public class MakeSpaceState extends DragState {
  ...
  public MakeSpaceState(FloatPoint p_location, InteractiveState p_parent_state, GuiBoardManager p_board_handling) {
    ...
    route = new Route(p_location.round(), hdlg.interactiveSettings.get_layer(), shove_trace_width_arr, layer_active_arr,
        route_net_no_arr, 0, ViaRule.EMPTY, true, hdlg.interactiveSettings.get_trace_pull_tight_region_width(),
        hdlg.interactiveSettings.get_trace_pull_tight_accuracy(), null, null, hdlg.get_routing_board(), false, false, false,
        hdlg.interactiveSettings.get_hilight_routing_obstacle());
  }
