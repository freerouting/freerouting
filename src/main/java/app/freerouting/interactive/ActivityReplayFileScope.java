...
public abstract class ActivityReplayFileScope {
  ...
  public static final ActivityReplayFileScope SET_CLEARANCE_COMPENSATION = new SetClearanceCompensationScope(
      "set_clearance_compensation");
  public static final ActivityReplayFileScope SET_DRAG_COMPONENTS_ENABLED = new SetDragComponentsEnabledScope(
      "set_drag_component_enabled");
  public static final ActivityReplayFileScope SET_LAYER = new SetLayerScope("set_layer");
  public static final ActivityReplayFileScope SET_MANUAL_TRACE_CLEARANCE_CLASS = new SetManualTraceClearanceClassScope(
      "set_manual_trace_clearance_class");
  public static final ActivityReplayFileScope SET_MANUAL_TRACE_HALF_WIDTH = new SetManualTraceHalfWidthScope(
      "set_manual_trace_half_width");
  public static final ActivityReplayFileScope SET_MANUAL_TRACEWIDTH_SELECTION = new SetManualTraceWidthSelectionScope(
      "set_manual_tracewidth_selection");
  public static final ActivityReplayFileScope SET_PULL_TIGHT_ACCURACY = new SetPullTightAccuracyScope(
      "set_pull_tight_accuracy");
  public static final ActivityReplayFileScope SET_PULL_TIGHT_REGION_WIDTH = new SetPullTightRegionWidthScope(
  ...
  public static final ActivityReplayFileScope SET_SELECT_ON_ALL_LAYER = new SetSelectOnAllLayerScope(
  ...
  public static final ActivityReplayFileScope SET_IGNORE_CONDUCTION = new SetIgnoreConductionScope(
  ...
  public static final ActivityReplayFileScope EXTEND_TO_WHOLE_CONNECTED_SETS = new ExtendToWholeConnectedSetsScope(
      "extend_to_whole_connected_sets");
  public static final ActivityReplayFileScope EXTEND_TO_WHOLE_CONNECTIONS = new ExtendToWholeConnectionsScope(
      "extend_to_whole_connections");
  public static final ActivityReplayFileScope EXTEND_TO_WHOLE_COMPONENTS = new ExtendToWholeComponentsScope(
  ...
  public static final ActivityReplayFileScope ASSIGN_CLEARANCE_CLASS = new AssignClearanceClassScope(
      "assign_clearance_class");
  public static final ActivityReplayFileScope ASSIGN_SELECTED_TO_NEW_NET = new AssignSelectedToNewNetScope(
      "assign_selected_to_new_net");
  public static final ActivityReplayFileScope ASSIGN_SELECTED_TO_NEW_GROUP = new AssignSelectedToNewGroupScope(
  ...
  public static final ActivityReplayFileScope OPTIMIZE_SELECTED = new OptimizeSelectedScope("optimize_selected");
  ...
  public static final ActivityReplayFileScope CREATING_POLYGONSHAPE = new CreatePolygonShapeScope(
  ...
  public static final ActivityReplayFileScope CHANGE_PLACEMENT_SIDE = new ChangePlacementSideScope(
  ...
  /**
   * This array contains all (above) created objects of this class. Initializing
   * this static array automatically by the program did not work correctly, so the
   * programmer has to keep it up-to-date by
   * hand.
   */
  ...
  /**
   * Reads the scope from the input logfile. Returns the active interactive state
   * after reading the scope.
   */
  public abstract InteractiveState read_scope(ActivityReplayFile p_activityReplayFile, InteractiveState p_return_state,
  ...
  private abstract static class CornerlistScope extends ActivityReplayFileScope {
    ...
    /**
     * Reads the next corner list scope together with its interior scopes (layer
     * change for example) from the input logfile. Returns the active interactive
  ...
  private static class SelectRegionScope extends ActivityReplayFileScope {
    ...
    public InteractiveState read_scope(ActivityReplayFile p_activityReplayFile, InteractiveState p_return_state,
      ...
      InteractiveState curr_state = SelectItemsInRegionState.get_instance(lower_left, p_return_state, p_board_handling,
          null);
  ...
  private static class CutoutRouteScope extends ActivityReplayFileScope {
    ...
    public InteractiveState read_scope(ActivityReplayFile p_activityReplayFile, InteractiveState p_return_state,
      ...
      InteractiveState curr_state = CutoutRouteState.get_instance(item_list, lower_left, p_return_state.return_state,
  ...
  private static class SetSnapAngleScope extends ActivityReplayFileScope {
    ...
    public InteractiveState read_scope(ActivityReplayFile p_activityReplayFile, InteractiveState p_return_state,
      ...
      p_board_handling.get_routing_board().rules
          .set_trace_angle_restriction(AngleRestriction.valueOf(new_snap_angle_no));
      return p_return_state;
    }
  }
  ...
  private static class SetSelectableScope extends ActivityReplayFileScope {
    ...
    public InteractiveState read_scope(ActivityReplayFile p_activityReplayFile, InteractiveState p_return_state,
      ...
      ItemSelectionFilter.SelectableChoices item_type = ItemSelectionFilter.SelectableChoices.values()[item_type_no];
      if (selection == 0) {
  ...
  private static class ZoomFrameScope extends ActivityReplayFileScope {
    ...
    public InteractiveState read_scope(ActivityReplayFile p_activityReplayFile, InteractiveState p_return_state,
        GuiBoardManager p_board_handling) {
      Point2D lower_left = p_board_handling.graphics_context.coordinate_transform
          .board_to_screen(p_activityReplayFile.read_corner());
      Point2D upper_right = p_board_handling.graphics_context.coordinate_transform
          .board_to_screen(p_activityReplayFile.read_corner());
