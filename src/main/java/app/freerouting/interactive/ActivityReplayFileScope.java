...
public abstract class ActivityReplayFileScope
{
    ...
    private static class CopyItemScope extends CornerlistScope
    {
                ...
                InteractiveState p_return_state, BoardHandling p_board_handling)
        {
            ...
            {
                java.util.Collection<app.freerouting.board.Item> item_list = ((SelectedItemState) p_return_state).get_item_list();
    ...
    private static class SetSnapAngleScope extends ActivityReplayFileScope
    {
        ...
        public InteractiveState read_scope(ActivityReplayFile p_activityReplayFile, InteractiveState p_return_state, BoardHandling p_board_handling)
        {
            ...
            p_board_handling.get_routing_board().rules.set_trace_angle_restriction(app.freerouting.board.AngleRestriction.arr[new_snap_angle_no]);
            return p_return_state;
        }
    }
    ...
    private static class SetSelectableScope extends ActivityReplayFileScope
    {
        ...
        public InteractiveState read_scope(ActivityReplayFile p_activityReplayFile, InteractiveState p_return_state, BoardHandling p_board_handling)
        {
            ...
            app.freerouting.board.ItemSelectionFilter.SelectableChoices item_type = app.freerouting.board.ItemSelectionFilter.SelectableChoices.values()[item_type_no];
            if (selection == 0)
            {
