...
public class StitchRouteState extends RouteState {
  ...
  public void draw(Graphics p_graphics) {
    ...
    double display_width = hdlg.get_trace_halfwidth(route.net_no_arr[0], hdlg.interactiveSettings.get_layer());
    ...
    radius_with_clearance += hdlg.get_routing_board().clearance_value(cl_class, cl_class, hdlg.interactiveSettings.get_layer());
