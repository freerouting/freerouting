...
public class RouteState extends InteractiveState
{
    ...
    public static RouteState get_instance(FloatPoint p_location, InteractiveState p_parent_state, BoardHandling p_board_handling, ActivityReplayFile p_activityReplayFile)
    {
        ...
        if (picked_item instanceof app.freerouting.board.Pin && net_count > 1)
        {
            ...
            route_net_no_arr = get_route_net_numbers_at_tie_pin((app.freerouting.board.Pin) picked_item, p_board_handling.settings.layer);
        }
        else
        {
    ...
    public InteractiveState key_typed(char p_key_char)
    {
        ...
        if (Character.isDigit(p_key_char))
        {
            ...
            app.freerouting.board.LayerStructure layer_structure = hdlg.get_routing_board().layer_structure;
    ...
    public void display_default_message()
    {
        if (route != null)
        {
            app.freerouting.rules.Net curr_net = hdlg.get_routing_board().rules.nets.get(route.net_no_arr[0]);
