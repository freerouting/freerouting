...
public abstract class RegularTileShape extends TileShape {
   ...
   */
  public abstract Side compare(RegularTileShape other, int edgeIndex);

  /** Auxiliary function to implement the same function with parameter type RegularTileShape. */
  abstract Side compare(IntBox other, int edgeIndex);

  /** Auxiliary function to implement the same function with parameter type RegularTileShape. */
  abstract Side compare(IntOctagon other, int edgeIndex);
