...
public class InsertFoundConnectionAlgo
{
    ...
    boolean insert_neckdown(Point p_from_corner, Point p_to_corner, int p_layer, app.freerouting.board.Pin p_start_pin, app.freerouting.board.Pin p_end_pin)
    {
        if (p_start_pin != null)
        {
    ...
    private Point try_neck_down(Point p_from_corner, Point p_to_corner, int p_layer, app.freerouting.board.Pin p_pin, boolean p_at_start)
    {
