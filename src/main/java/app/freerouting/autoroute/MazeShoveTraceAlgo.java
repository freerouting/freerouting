...
public class MazeShoveTraceAlgo
{
            ...
            boolean p_shove_to_the_left, Collection<DoorSection> p_to_door_list)
    {
        ...
        app.freerouting.board.PolylineTrace obstacle_trace = (app.freerouting.board.PolylineTrace)p_obstacle_room.get_item();
     ...
     */
    private static boolean end_points_matching(app.freerouting.board.PolylineTrace p_trace, Item p_from_item)
    {
        ...
        {
            app.freerouting.board.PolylineTrace from_trace = (app.freerouting.board.PolylineTrace) p_from_item;
