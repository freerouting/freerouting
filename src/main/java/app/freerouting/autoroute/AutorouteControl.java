...
public class AutorouteControl
{
    ...
    public AutorouteControl(RoutingBoard p_board, int p_net_no, app.freerouting.interactive.Settings p_settings)
    {
    ...
    /** Creates a new instance of AutorouteControl for the input net */
    public AutorouteControl(RoutingBoard p_board, int p_net_no, app.freerouting.interactive.Settings p_settings, int p_via_costs, ExpansionCostFactor[] p_trace_cost_arr)
    {
    ...
    private AutorouteControl(RoutingBoard p_board, app.freerouting.interactive.Settings p_settings,
