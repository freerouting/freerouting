 ...
 * board-lifecycle events. This interface deliberately has <em>no</em> dependency on the {@code
 * interactive} or {@code gui} packages so that the parser stays self-contained.
 *
 * <p>The only production implementation is the package-private {@code MinimalBoardManager} nested
 * inside {@link ReadScopeParameter}.
 */
