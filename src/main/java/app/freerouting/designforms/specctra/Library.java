...
public class Library extends ScopeKeyword
{
    ...
    public boolean read_scope(ReadScopeParameter p_par)
    {
        ...
        board.library.padstacks = new app.freerouting.library.Padstacks(p_par.board_handling.get_routing_board().layer_structure);
        ...
        while (it.hasNext())
        {
            ...
            for (int i = 0; i < pin_arr.length; ++i)
            {
                ...
                app.freerouting.library.Padstack board_padstack = board.library.padstacks.get(pin_info.padstack_name);
            ...
            for (int i = 0; i < keepout_arr.length; ++i)
            {
                ...
                app.freerouting.geometry.planar.Area curr_area = Shape.transform_area_to_board_rel(curr_keepout.shape_list, p_par.coordinate_transform);
                                        ...
                                        CoordinateTransform p_coordinate_transform, app.freerouting.library.Padstacks p_board_padstacks)
    {
        ...
        app.freerouting.geometry.planar.ConvexShape[] padstack_shapes = new app.freerouting.geometry.planar.ConvexShape[p_layer_structure.arr.length];
