...
public class Package
{
    ...
    public static void write_scope(WriteScopeParameter p_par, app.freerouting.library.Package p_package) throws java.io.IOException
    {
        ...
        for (int i = 0; i < p_package.pin_count(); ++i)
        {
            ...
            app.freerouting.library.Padstack curr_padstack = p_par.board.library.padstacks.get(curr_pin.padstack_no);
     ...
     */
    public static void write_placement_scope(WriteScopeParameter p_par, app.freerouting.library.Package p_package)
