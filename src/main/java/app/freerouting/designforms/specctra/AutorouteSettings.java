...
public class AutorouteSettings
{
    ...
    static void write_scope(IndentFileWriter p_file, app.freerouting.interactive.AutorouteSettings p_settings,
                            app.freerouting.board.LayerStructure p_layer_structure, IdentifierType p_identifier_type) throws java.io.IOException
    {
        p_file.start_scope();
