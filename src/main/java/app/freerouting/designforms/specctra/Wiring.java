...
class Wiring extends ScopeKeyword
{
    ...
    private Item read_wire_scope(ReadScopeParameter p_par)
    {
        ...
        if (border_shape != null)
        {
            ...
            {
                clearance_class_no =
                        net_class.default_item_clearance_classes.get(app.freerouting.rules.DefaultItemClearanceClasses.ItemClass.AREA);
            }
        ...
        else if (path instanceof PolygonPath)
        {
            ...
            {
                clearance_class_no =
                        net_class.default_item_clearance_classes.get(app.freerouting.rules.DefaultItemClearanceClasses.ItemClass.TRACE);
            }
    ...
    private boolean read_via_scope(ReadScopeParameter p_par)
    {
        try
        {
            ...
            if (clearance_class_no < 0)
            {
                clearance_class_no =  net_class.default_item_clearance_classes.get(app.freerouting.rules.DefaultItemClearanceClasses.ItemClass.VIA);
            }
