...
public class DsnFile
{
                                  ...
                                  app.freerouting.board.BoardObservers p_observers, app.freerouting.datastructures.IdNoGenerator p_item_id_no_generator, TestLevel p_test_level)
    {
        ...
        //app.freerouting.tests.Validate.check("after reading dsn", read_scope_par.board_handling.get_routing_board());
        return result;
    }
     ...
     */
    private static boolean adjust_plane_autoroute_settings(app.freerouting.interactive.IBoardHandling p_board_handling)
    {
        ...
        java.util.Collection<app.freerouting.board.ConductionArea> conduction_area_list = new java.util.LinkedList<app.freerouting.board.ConductionArea>();
        ...
        {
            app.freerouting.geometry.planar.TileShape[] curr_piece_arr = board_outline.get_shape(i).split_to_convex();
        ...
        for (app.freerouting.board.ConductionArea curr_conduction_area : conduction_area_list)
        {
            ...
            app.freerouting.geometry.planar.TileShape[] convex_pieces = curr_conduction_area.get_area().split_to_convex();
            double curr_area = 0;
            ...
            if (curr_conduction_area.get_fixed_state().ordinal() < app.freerouting.board.FixedState.USER_FIXED.ordinal())
            {
     ...
     */
    public static boolean write(app.freerouting.interactive.BoardHandling p_board_handling, java.io.OutputStream p_file, String p_design_name, boolean p_compat_mode)
    {
    ...
    private static void write_pcb_scope(app.freerouting.interactive.BoardHandling p_board_handling, IndentFileWriter p_file, String p_design_name, boolean p_compat_mode)
