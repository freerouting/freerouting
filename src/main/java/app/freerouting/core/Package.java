...
public class Package implements Comparable<Package>, ObjectInfoPanel.Printable, Serializable {
   ...
   */
  public Package(String p_name, int p_no, Pin[] p_pin_arr, Shape[] p_outline, double[] p_outline_widths, Keepout[] p_keepout_arr, Keepout[] p_via_keepout_arr, Keepout[] p_place_keepout_arr, boolean p_is_front,
