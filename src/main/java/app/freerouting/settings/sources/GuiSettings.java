 ...
 * this source with the {@link app.freerouting.interactive.InteractiveSettings} singleton — a
 ...
 *
 * <p>In headless / CLI / API mode no {@code GuiSettings} (or subclass) source is registered at all;
 * the merger falls back to lower-priority defaults for the fields that would otherwise be supplied
 * here.
 *
