...
/**
 * Provides router settings from API endpoints. Only the settings specified via API will be
 * non-null. This has the highest priority and overrides all other settings.
 */
public class ApiSettings implements SettingsSource {
   ...
   *
   * @param settings Router settings from the API (should have only specified fields non-null)
   */
