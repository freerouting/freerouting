...
public class OptimizerScoringSettings implements Serializable, Cloneable {
  ...
  @Override
  public OptimizerScoringSettings clone() {
    try {
      return (OptimizerScoringSettings) super.clone();
